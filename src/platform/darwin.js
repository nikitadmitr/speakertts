...
class SpeakerPlatformDarwin extends SpeakerPlatformBase {
    constructor() {
        super();
    ...
    getVoices() {
        throw new Error(`speaker.export(): does not support platform ${this.platform}`);
    }
}

module.exports = SpeakerPlatformDarwin;
